...
export class LayoutService {
  ...
  private _configUpdate$ = this.configUpdate.asObservable()
  private _overlayOpen$ = this.overlayOpen.asObservable()
  constructor() {
    effect(() => {
  ...
  public set configUpdate$(value) {
    this._configUpdate$ = value
  }
  public set overlayOpen$(value) {
